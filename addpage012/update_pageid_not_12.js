...
pids.forEach(function(page_id){

  var page = db.pages.find({"page_id":page_id,"page_index":{"$ne":12}},{"page_id":1,"_id":0,"floor_id":1,"page_index":1,"meta.created_at":1}).sort({"page_index":1,"page_id":1});

	while(page.hasNext()){
		var temp = page.next();
    printjson({"page_index":temp['page_index'],"page_id":temp['page_id'],"floor_id":temp['floor_id'],"meta":{"created_at":temp['meta']['created_at']}});
